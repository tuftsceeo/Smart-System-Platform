...
\begin{figure}[H]
    ...
    \includegraphics[width=.49\linewidth]{rstudio/survey/plots/ssp.png}
    \includegraphics[width=.49\linewidth]{rstudio/survey/plots/toolpage.png}
    \includegraphics[width=.4\linewidth]{rstudio/survey/plots/architecture.png}
    \includegraphics[width=.4\linewidth]{rstudio/survey/plots/component.png}
    \vspace{\ftspace}
