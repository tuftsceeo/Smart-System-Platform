\cleardoublepage%
\chapter*{\label{chap:apx_e}Appendix E - Test Code\chaptermark{Appendix E}}%
\chaptermark{Appendix E}%
\addcontentsline{toc}{section}{Appendix E - Code and Experimental Data}

\section*{Maximum Range Test and Reliability Test Code}
\addcontentsline{toc}{subsection}{Maximum Range Test and Reliability Test Code}
\subsection*{boop-o-meter Code:}
%[...]
{\tiny\lstinputlisting[breaklines]{./software/applications/boop-o-meters/boop-o-meter 300.py}}
% \subsection*{Results:}
...
\section*{Ping Response Time Code}
\addcontentsline{toc}{subsection}{Ping Response Time Code}
%\subsection*{Code:}
%\subsubsection*{Shout:}
%[...]
{\tiny\lstinputlisting[breaklines]{./software/applications/ping/shout.py}}
%\subsubsection*{Echo:}
%[...]
...
%\subsection*{Code:}
%[...]
{\tiny\lstinputlisting[breaklines]{./software/applications/rssi_testing/rssi.py}}
% \subsection*{Results:}
% \begin{table}[H]
%     \centering
%     \begin{tabular}{c|c}
...
\section*{Power Consumption and Battery Endurance Test Code}
\addcontentsline{toc}{subsection}{Battery Consumption Test Code}
%\subsection*{Code:}
%[...]
{\tiny\lstinputlisting[breaklines]{./software/applications/rssi_testing/rssi.py}}
%\subsection*{Results:}
