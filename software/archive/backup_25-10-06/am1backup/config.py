config = {'ap_channel': 1, 'id': '64e83385d3bc', 'name': 'Nickname', 'sta_mac': '64:e8:33:85:d3:bc', 'ap_mac': '64:e8:33:85:d3:bd', 'configuration': 'AM1', 'sta_channel': 1, 'version': '111422222410322'}
...
hive_config = {'hive': False, 'refreshrate': 100, 'recipients': [b'd\xe83\x84\xd8\x18', b'\x8c\xbf\xea\xcb\xa3\x14'], 'mode': 'logic', 'sender_sensor_list': [[b'\x8c\xbf\xea\xcb\xa3\x14', 'sw1']], 'controller': {'ki': None, 'kd': None, 'kp': None}, 'formula': 'Hello'}
