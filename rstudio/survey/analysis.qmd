...
ggsave(filename = paste0("plots/completion.png"), plot = p_completion, width = 6, height = 6, dpi = 300, bg = "white")
...
ggsave(filename = paste0("plots/logic.png"), plot = p_logic, width = 6, height = 6, dpi = 300, bg = "white")
...
ggsave(filename = paste0("plots/architecture.png"), plot = p_architecture, width = 8, height = 6, dpi = 300, bg = "white")
...
p_toolpage <- ggplot(toolpage_counts, aes(x = Aspect, y = Count, fill = Response)) +
  ...
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.3),
        plot.subtitle = element_text(hjust = 9.2)
        )

ggsave(filename = paste0("plots/toolpage.png"), plot = p_toolpage, width = 8, height = 6, dpi = 300, bg = "white")
...
p_component <- ggplot(component_counts, aes(x = Aspect, y = Count, fill = Response)) +
  ...
  labs(title = "Components of the Smart System Platform Used",
...
ggsave(filename = paste0("plots/component.png"), plot = p_component, width = 8, height = 6, dpi = 300, bg = "white")
